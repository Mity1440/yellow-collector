...
import com.dmakarevich.yellow_collector.services.storage.exceptions.StorageException;
...
public class FileSystemStorageService implements StorageService{
    ...
    @Autowired
    public FileSystemStorageService(StoragePathsProperties properties) {
    ...
    public void store(MultipartFile file) {
        try {
            ...
            Path destinationFile = this.location.resolve(Paths.get(newFileName())).normalize().toAbsolutePath();
