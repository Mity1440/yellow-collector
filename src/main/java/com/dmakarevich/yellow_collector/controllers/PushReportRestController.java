...
import com.dmakarevich.yellow_collector.services.processors.PushReportProcessor;
...
public class PushReportRestController {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/pushReport", consumes = { MediaType.MULTIPART_FORM_DATA_VALUE })
